...
def visualize_boxes_and_labels_on_image_array(
    ...
    for box, color in box_to_color_map.items():
        ...
        pred_str.append(box_to_display_str_map[box])
        #print("ymin: ", format(ymin, '.5g'))
        bb_cord.append([ymin, xmin, ymax,xmax])
        #bb_cord.append([ymin, xmin])    
        #print("bb_cord: ",bb_cord)
    return image, pred_str, bb_cord
...
def visualize_boxes(image, boxes, labels, probs, class_labels):
    ...
    out_image, pred_str, bb_cord = visualize_boxes_and_labels_on_image_array(image, boxes, labels, probs, category_index)
    return out_image, pred_str, bb_cord
