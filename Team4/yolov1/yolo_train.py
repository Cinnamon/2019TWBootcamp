...
def main():
    ...
    train_root = 'WeaponS/WeaponS/'   #where you place images
    ...
    #load model
    '''
    load_checkpoint('yolov1/model_19_3_13.pth', model)
    ...
    train_dataset = yolodataset(root=train_root, train=True, transform = transforms.ToTensor(), label='yolo_train.txt')
    train_loader = DataLoader(train_dataset, batch_size=16, shuffle=True, num_workers=2)

    valid_dataset = yolodataset(root=train_root, train=False, transform = transforms.ToTensor(), label='yolo_test.txt')
